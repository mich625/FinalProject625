...
Bluecross.Sum = FL_local_summary(Billing.Amount ~ Age + Gender + Medical.Condition + Admission.Type + Medication, Blue.cross)
Cigna.Sum = FL_local_summary(Billing.Amount ~ Age + Gender + Medical.Condition + Admission.Type + Medication, Cigna)
Medicare.Sum = FL_local_summary(Billing.Amount ~ Age + Gender + Medical.Condition + Admission.Type + Medication, Medicare)
...
```{r}
oracle = lm(Billing.Amount ~ Age + Gender + Medical.Condition + Admission.Type + Medication, data = healthcare_dataset)
